...
# 1. Mini-project 1: Data visualization (Due 10/5 5pm) {#miniproj1}
...
* **Edited on 9/28**: +1 for ~~explaining the color mapping~~ justifying/explaining the choice of color mapping, even if none. In other words, do not add color for sake of adding color (this is called [chartjunk](https://en.wikipedia.org/wiki/Chartjunk){target="_blank"}). Rather use color only if you feel it adds value to your plot.
