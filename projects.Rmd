...
There are 16 possible points for this mini-project.
...
* +1 for using [code folding](https://bookdown.org/yihui/rmarkdown/html-document.html#code-folding) to keep your code hidden, but still make it available.
