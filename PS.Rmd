...
* Chapter 4: "Transform your data"  
    + Read the following [Google Form](https://docs.google.com/forms/d/e/1FAIpQLScNT11Dv8aSirruTwRLjUdhNqGbJSnlpDdqf8fgY8DvNcMu9w/viewform){target="_blank"} first. Note this form is different than the Google Form for Chapter 4.
    + Complete the DataCamp chapter.
    + Complete the above Google Form.    
...
* Download the following Rmd template file: <a href="static/PS/PS06_lastname_firstname.Rmd" download>`PS06_lastname_firstname.Rmd`</a> and rename it appropriately.
