...
1. **Data wrangling**: Do the following...
    1. Login to [RStudio Server](http://rstudio.smith.edu/){target="_blank"}. If you can't, follow along with someone nearby and speak to me after class.
...
* Make sure:
    + You are part of the class Slack team (click hashtag icon in menubar above) and 
        ...
        1. Can see the `#192_data_science` channel
    ...
    + You have access to the [2018-09 SDS192 Intro to Data Science](https://www.datacamp.com/enterprise/2018-09-sds192-intro-to-data-science){target="_blank"} DataCamp group.
* Having issues getting set up? Need help? Then fill out this [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSehdLkV7PPj2_ghaHROdqb4fRCdJDv0ksDLoMw95WpPnfxzqQ/viewform){target="_blank"}.
