...
1. Data science (pink): Data visualization via `ggplot2`, "tidy" data format, and data wrangling via `dplyr`
...
1. Statistical inference (yellow): confidence intervals, hypothesis testing, inference for regression, other inferential methods
-->
