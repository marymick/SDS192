...
* **Topics**:
    1. Tools of the trade (orange): R, RStudio, R packages, R Markdown, GitHub.
    1. Data visualization (pink): Grammar of Graphics, 5 named graphs, color theory.
...
* **Readings**: MD is ModernDive, MDSR is Modern Data Science with R.
...
1. Data visualization:
    ...
    1. [Actual](https://deskarati.com/2012/03/31/london-undergrounds-real-map/) London Underground map
1. Data wrangling: Do the following:
    1. Login to [RStudio Server]()
1. Maps and spatial data:
    1. [ColorBrewer 2.0](http://colorbrewer2.org/): Color Advice for Maps
    1. Interactive maps via the [leaflet JavaScript library](https://leafletjs.com/), which we'll interface with using the [`leaflet` R package](https://rstudio.github.io/leaflet/).
1. Text data:
    1. Who wrote the New York Times anonymous opinion editorial ["I Am Part of the Resistance Inside the Trump Administration"](https://www.nytimes.com/2018/09/05/opinion/trump-white-house-anonymous-resistance.html)? A `tidytext` [approach](http://varianceexplained.org/r/op-ed-text-analysis/) to answering this question.
