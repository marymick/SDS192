...
(Slightly longer than usual): Doing by hand what `geom_boxplot()` automates: drawing a boxplot: say we want to plot a boxplot of the following `r nrow(example)` values which are pre-sorted: 
...
Read the following Chance Magazine article [Looking Good on Course Evaluations](http://chance.amstat.org/2013/04/looking-good/){target="_blank"}. In particular, note the introductory paragraph:
