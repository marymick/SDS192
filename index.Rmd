...
* Added to "Event" column in calendar above: Class time to work on mini-project 1:
    + Friday 9/28
    + Wednesday 10/3
* Solutions to PS02 [posted](#PS02_R_solutions). Please download these to your computer and
open them in RStudio for a brief in class discussion.
    + **RStudio Desktop users**: To guarantee `PS02_solutions.R` opens in the RStudio app (AKA a car's dashboard) and not the regular R app (AKA a car's engine), don't double-click `PS02_solutions.R` directly, but rather go to Files panel of RStudio and find/click/open your file from there.
...
* Complete *only* the following two chapters from the "Introduction to the Tidyverse" course, which you should see in the following [link](https://www.datacamp.com/enterprise/2018-09-sds192-intro-to-data-science/assignments){target="_blank"}:
    ...
    * Chapter 4: "Types of visualizationsn"
...
<!--
/poll "Are you still encountering issues with RStudio Server?" "No" "Sometimes" "Often" anonymous
-->
...
<!--
/poll "Do you think you understand what the purpose of the `scratchpad.R` file is?" "Sort of" "Not really" anonymous

/poll "Had you heard of the term 'imposter syndrome' prior to today's lecture?" "yes & I'm a senior" "yes & I'm a junior" "yes & I'm a sophomore" "yes & I'm a first-year" "no & I'm a senior" "no & I'm a junior" "no & I'm a sophomore" "no & I'm a first-year" anonymous

/poll "What did you think of @SmithCollegeSDS faculty alumna @AmeliaMN visual essay on histograms?" "I love it!" "I like it" "It was alright" "meh" anonymous
-->
